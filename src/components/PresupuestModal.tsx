...
export default function PresupuestModal() {
        ...
        <Dialog as="div" className="relative z-10" onClose={() => dispatch({type: 'close-modal'})}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-[#565668] px-10 py-6 text-left align-middle shadow-xl transition-all">
